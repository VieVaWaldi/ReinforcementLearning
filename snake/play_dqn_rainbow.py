...
if __name__ == "__main__":
    ...
    env = SnakeEnvironment(draw=True, fps=150, debug=False)
    ...
    for i in range(10):
        ...
        sum_all_reward += total_reward
    print("Total reward avg. = ", round(sum_all_reward / 10, 1))
