...
#####################################################################################################
NAME = 'snake_dqn/-expdecay=0.99995-gamma=.9-batchsize=20-nn=512-lr=0.001-normalization'
WRITE = True
DRAW = False
SAVE_MODEL = True
LOAD_NAME = 'snake_dqn/-expdecay=0.99995-gamma=.9-batchsize=20-nn=512-lr=0.001-normalization-PART=0'
#####################################################################################################
